...
namespace EndlessCarChase
{
	...
	public class ECCGameController : MonoBehaviour 
	{
        ...
        public void  CollectCoin( int points)
        {
	        ...
	        {
		        coinsCollected = 0;
		        PlayArcadeIntegration.Instance.SendGameEventCredit();
	        ...
	        if (coinText)
	        {
		        coinText.GetComponent<Text>().text = coinsCollected.ToString();

		        // Play the score object animation
		        if (coinText.GetComponent<Animation>()) coinText.GetComponent<Animation>().Play();
	        }
        }
	}
}